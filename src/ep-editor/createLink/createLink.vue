<template>
  <ep-modal v-model="createLinkModal" :before-close="closeCreateLinkModal" width="840px" title="编辑链接" :wrap-close="false">
    <div class="body-containter">
      ...
      <div class="right-container">
        ...
        <div v-if="activeIndex == 2">
          <div class="table-container">
            <ep-table :data="editJournal.attachment"  size="small">
              <ep-table-item column="title" title="标题">
                <template slot-scope="props">
                  <ep-tag type="primary">附件</ep-tag>
                  <a style="color: #3572b0;padding-left:7px" @click="fillAttachmentLinkName(props.row)">{{props.row.name}}</a>
                </template>
              </ep-table-item>
            </ep-table>
          </div>
          <div class="meta-link" style="padding: 10px 12px;">
...
<script>
import {getJournalPage} from "../api";
