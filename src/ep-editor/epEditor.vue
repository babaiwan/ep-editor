<template>
  <div class="quill-editor">
    <slot name="toolbar">
<!--      rename id if needs multi toolbar: like  [toolbar-id1] -->
      <div id="toolbar">
        ...
        <div style="align-items: center;display: flex">
          <button style="color: grey;font-size: 13px;width: 45px" @click="preview">预览</button>
          <ep-dropdown type="hover" position="bottom" @item-click="handleItemClick">
            <div slot="item">
              <button type="button" style="color: grey;font-size: 13px;width: 38px;">更多</button>
            </div>

            <ep-dropdown-item item-key="html">
               <ep-popover
                 v-model="htmlInsertPopover"
                 ref="htmlEditPopover"
                 placement="right"
                 width="480"
                ...
                <a slot="reference">
                  <span style="color: black">插入html</span>
                </a>
              </ep-popover>
            </ep-dropdown-item>
            <ep-dropdown-item item-key="convertPdf2Html">
              <font>
                Pdf 转 html 并插入
              </font>
            </ep-dropdown-item>
            <ep-dropdown-item item-key="convertWord2Html">
              <font>
                Word (仅支持docx) 转 html 并插入
              </font>
            </ep-dropdown-item>
          </ep-dropdown>
        </div>
    ...
    <div style="min-height: 265px" ref="editor"></div>
...
export default {
  ...
  data() {
    return {
      ...
      uploadDocxModal: false,
      convertPdf2HtmlModal: false,
