...
const MENU_ITEMS_DEFAULT = {
  ...
  alignTable:{    // align the table center
    text:'居中',
    handler(){
      const tableContainer = Quill.find(this.table)
      if (tableContainer.domNode.align == ""){
        tableContainer.domNode.align = "center"
      }else{
        tableContainer.domNode.align = ""
      }
      this.quill.update(Quill.sources.USER)
    }
  }
