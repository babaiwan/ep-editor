<template>
  <ep-modal
    v-model="drawIODialog"
    width="800px"
    :default-render="true"
    @open="initEditor"
    :before-close="closeDrawIO"
  >
    <div id="drawIoContainer" style="height: 650px"></div>
    <div class="drawIoFooter">
      <ep-button type="primary" @click="confirm">确定</ep-button>
      <ep-button @click="closeDrawIO">取消</ep-button>
    </div>
