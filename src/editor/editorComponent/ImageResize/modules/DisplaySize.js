...
export class DisplaySize extends BaseModule {
  ...
  onUpdate = () => {
    ...
    } else if (this.resizer.img.style.float === 'right') {
  ...
  getCurrentSize = () => [
    this.resizer.img.width,
    Math.round((this.resizer.img.width / this.resizer.img.naturalWidth) * this.resizer.img.naturalHeight),
  ]
}
